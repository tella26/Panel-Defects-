...
class ResNet34(nn.Module):
    def __init__(self, input_channel, n_classes):
        ...
        self.b2 = nn.Sequential(*residualBlock(64, 64, 3, first_block=True))
        self.b3 = nn.Sequential(*residualBlock(64, 128, 4))
        self.b4 = nn.Sequential(*residualBlock(128, 256, 6))
        self.b5 = nn.Sequential(*residualBlock(256, 512, 3))
